...
class Empleado(Base):
    ...
    # Fase 6/7: datos maestros para exportadores legales (PLAME/T-Registro/AFPnet),
    # dispersión bancaria y actualización de datos por el propio empleado.
    tipo_documento = Column(String(20), nullable=True, default="DNI")   # DNI | CE | Pasaporte
    numero_documento = Column(String(20), nullable=True)
    direccion = Column(String(200), nullable=True)
    banco = Column(String(40), nullable=True)                           # BCP | BBVA | Interbank | ...
    cuenta_bancaria = Column(String(30), nullable=True)
    cci = Column(String(30), nullable=True)                             # Código de Cuenta Interbancario
    cuspp = Column(String(20), nullable=True)                           # código único AFP (SPP)
